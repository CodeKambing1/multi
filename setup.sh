...
wget https://raw.githubusercontent.com/CodeKambing1/multi/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/CodeKambing1/multi/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/CodeKambing1/multi/main/xray-menu.sh" && chmod +x menu
wget -O xp "https://raw.githubusercontent.com/CodeKambing1/multi/main/xp.sh" && chmod +x xp
...
wget -O tcp "https://raw.githubusercontent.com/CodeKambing1/multi/main/tcp.sh" && chmod +x tcp
