...
Name=$(curl -sS https://raw.githubusercontent.com/CodeKambing1/access/main/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/CodeKambing1/access/main/ip | grep $MYIP | awk '{print $3}')
